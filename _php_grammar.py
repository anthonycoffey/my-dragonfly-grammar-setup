...
class PHPControlStructures(MappingRule):
    mapping = {
        ...
        "try catch": Text("try {") + Key("enter") + Key("enter") + Text("}") + Key("enter") + Text(
            "catch(<ExceptionClass> e) {") + Key("enter") + Key("enter") + Text("}"),
...
class PHPUsefulMethods(MappingRule):
    mapping = {
        "print statement": Text("print_r();") + Key("left") + Key("left"),
        "echo statement": Text("echo \"\";") + Key("left") + Key("left"),
        "dump statement": Text("var_dump();") + Key("left") + Key("left"),
        "log statement": Text("error_log(print_r(,true));") + Key("left") + Key("left") + Key("left") + Key("left") + Key("left") + Key("left") + Key("left") + Key("left"),
    }
